...
export const sportsPickSchema = z.object({
  ...
  event_time: nullableStr,
  event_hint: nullableStr,
        ...
        properties: {
          ...
          sports_pick: {
            ...
            properties: {
              ...
              event_time: { type: ["string", "null"], description: "Game time as spoken, e.g. '8:20 PM ET'; null if not stated." },
              event_hint: { type: ["string", "null"], description: "Non-date reference to when the game is, exactly as spoken: 'Week 1', 'Thursday night opener', 'Sunday Night Football'. Never convert it to a date." },
