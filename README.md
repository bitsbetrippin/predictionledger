...
├── scripts/                  cross-platform Node launchers (no bash/PowerShell required); upgrade-rehearsal.mjs, report.mjs, doctor.mjs, backup.mjs
...
| [docs/OPERATIONS_REFERENCE.md](docs/OPERATIONS_REFERENCE.md) | a hold, an alert or a state on the Trades page needs explaining in plain English — what it means, what the app did, what you do. |
